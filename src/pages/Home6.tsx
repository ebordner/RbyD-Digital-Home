...
// --- Testimonial Components for Home 6 ---

const Testimonial6 = ({ quote, attribution }: { quote: string; attribution: string; key?: any }) => (
    ...
    <Section className="py-12">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        {testimonials.map((t, i) => (
          <Testimonial6 key={i} quote={t.quote} attribution={t.attribution} />
        ))}
      </div>
