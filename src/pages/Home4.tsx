...
const Navbar4 = () => (
  <nav className="fixed top-0 w-full z-50 bg-[#FDFCF0]/80 backdrop-blur-md border-b border-[#C5A059]/20 px-6 py-4 flex justify-between items-center">
    ...
    <div className="hidden md:flex gap-8 text-[13px] font-bold uppercase tracking-[0.2em] text-[#333333]">
    ...
    <div className="min-h-screen font-sans bg-[#FDFCF0] text-[#000000] selection:bg-[#C5A059] selection:text-[#FDFCF0]">
      ...
      <header className="relative pt-48 pb-32 overflow-hidden border-b border-[#C5A059]/10">
        ...
        <Section className="text-center">
          ...
          >
            <span className="inline-block px-4 py-1.5 rounded-full bg-[#C5A059]/10 text-[#C5A059] text-[13px] font-bold tracking-[0.3em] uppercase mb-6 border border-[#C5A059]/20">
              The Top 5% Standard
            </span>
      ...
      <Section id="experience" className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="absolute -bottom-8 -right-8 bg-[#1B263B] p-8 rounded-xl max-w-xs shadow-2xl border border-[#C5A059]/30">
            ...
            <div className="text-[13px] text-[#FDFCF0] font-bold uppercase tracking-widest leading-tight">
        ...
        >
          ...
          <div className="space-y-6 text-[#333333] text-lg leading-relaxed">
            ...
            <div className="bg-[#F2F0E4] p-8 rounded-xl border-l-4 border-[#C5A059] shadow-sm">
              <p className="text-[#1B263B] font-bold mb-2 italic uppercase tracking-widest text-[13px]">My last corporate launch?</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-[#FDFCF0]/5 p-8 rounded-xl text-center border border-[#C5A059]/20 hover:border-[#C5A059]/50 transition-colors">
                ...
                <p className="text-[12px] text-[#FDFCF0]/50">{item.desc}</p>
              </div>
            ))}
          </div>
        </Section>
      ...
      <Section id="framework" className="relative">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#333333]/60 text-base">It doesn't validate revenue architecture.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#333333]/60 text-base">Ensures your foundation holds under scale.</p>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-[#F2F0E4] p-12 rounded-2xl border border-[#C5A059]/30 relative shadow-xl">
            ...
            <p className="text-xl font-bold mb-8 text-[#C5A059] uppercase tracking-widest text-[13px]">
      ...
      <div className="bg-[#1B263B] py-24 border-y border-[#C5A059]/20">
        <Section>
          <div className="text-center mb-16">
            ...
            <p className="text-[#FDFCF0]/60 max-w-2xl mx-auto uppercase tracking-[0.2em] text-[13px] font-bold">
      ...
      <Section id="diagnostic" className="relative">
        ...
        <div className="text-center mb-16">
          <span className="text-[#C5A059] font-bold tracking-[0.4em] uppercase text-[13px]">Diagnostic</span>
          ...
          <div className="lg:col-span-3 bg-[#F2F0E4] p-12 rounded-2xl border border-[#C5A059]/20 shadow-xl">
            ...
            <div className="grid sm:grid-cols-2 gap-8 mb-12">
              <div className="space-y-4">
                <h4 className="font-bold text-[#1B263B] flex items-center gap-2 uppercase tracking-widest text-[13px]">
        ...
        <div className="mt-16 text-center">
          <p className="text-[#333333]/50 text-[13px] font-bold uppercase tracking-widest">
