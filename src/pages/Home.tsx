...
// --- Testimonial Components for Home ---

const Testimonial = ({ quote, attribution }: { quote: string; attribution: string; key?: any }) => (
    ...
    <Section className="py-12">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        {testimonials.map((t, i) => (
          <Testimonial key={i} quote={t.quote} attribution={t.attribution} />
        ))}
      </div>
