...
// --- Testimonial Components for Home 5 ---

const Testimonial5 = ({ quote, attribution }: { quote: string; attribution: string; key?: any }) => (
  <div className={`bg-[#FDFCF0] p-4 md:p-5 rounded-2xl border border-[${COLORS.camel}]/20 shadow-sm hover:shadow-md transition-shadow group`}>
    ...
    <blockquote className={`text-[18px] leading-relaxed text-[${COLORS.black}] font-medium mb-4`}>
      “{quote}”
    </blockquote>
    ...
    <Section className="py-12">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        {testimonials.map((t, i) => (
          <Testimonial5 key={i} quote={t.quote} attribution={t.attribution} />
        ))}
      </div>
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          <div className={`lg:col-span-3 bg-[${COLORS.bone}] p-12 rounded-2xl border border-[${COLORS.camel}]/20 shadow-xl`}>
            ...
            <div className="grid sm:grid-cols-2 gap-8 mb-12">
              <div className="space-y-4">
                ...
                <ul className={`space-y-3 text-sm text-[${COLORS.charcoal}]/70`}>
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            <div className={`bg-[${COLORS.navy}] p-8 rounded-2xl flex-1 border border-[${COLORS.camel}]/30 text-[${COLORS.cream}] shadow-xl`}>
              ...
              <p className={`text-sm text-[${COLORS.cream}]/60 mb-8 leading-relaxed`}>
            ...
            <div className={`bg-[${COLORS.camel}] p-8 rounded-2xl text-[${COLORS.navy}] shadow-xl`}>
              ...
              <p className={`text-[${COLORS.navy}]/80 text-sm mb-6`}>
